...
//             sb.AppendLine("INSERT INTO team_movements.movement_status (status_name) VALUES ('Unknown') ON CONFLICT DO NOTHING;");
//             sb.AppendLine("INSERT INTO team_movements.movement_type (type_name) VALUES ('Unknown') ON CONFLICT DO NOTHING;");
//             sb.AppendLine("INSERT INTO team_movements.employee_group (group_name) VALUES ('Unknown') ON CONFLICT DO NOTHING;");
//             sb.AppendLine("INSERT INTO team_movements.employee_subgroup (subgroup_name) VALUES ('Unknown') ON CONFLICT DO NOTHING;");
//             sb.AppendLine("INSERT INTO team_movements.banner (banner_name) VALUES ('Unknown') ON CONFLICT DO NOTHING;");
//             sb.AppendLine("INSERT INTO team_movements.brand (brand_code, brand_name, brand_display_name) VALUES ('UNK', 'Unknown', 'Unknown') ON CONFLICT DO NOTHING;");
//             sb.AppendLine("INSERT INTO team_movements.department (department_code, department_name) VALUES ('UNK', 'Unknown') ON CONFLICT DO NOTHING;");
//             sb.AppendLine("INSERT INTO team_movements.cost_centre (cost_centre_code, cost_centre_name) VALUES ('UNK', 'Unknown') ON CONFLICT DO NOTHING;");
//             sb.AppendLine("INSERT INTO team_movements.role_type (role_name) VALUES ('Unknown') ON CONFLICT DO NOTHING;");
//             sb.AppendLine("INSERT INTO team_movements.job_role (job_role_name) VALUES ('Unknown') ON CONFLICT DO NOTHING;");
//             sb.AppendLine("INSERT INTO team_movements.mutual_flag (flag_name) VALUES ('Unknown') ON CONFLICT DO NOTHING;");
//             sb.AppendLine("INSERT INTO team_movements.break_type (break_name) VALUES ('Unknown') ON CONFLICT DO NOTHING;");
//             sb.AppendLine("INSERT INTO team_movements.history_event_type (event_type_name) VALUES ('Unknown') ON CONFLICT DO NOTHING;");
//             sb.AppendLine("```");
//             sb.AppendLine();
//
